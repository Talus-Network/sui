...
pub(crate) struct ObjectRuntimeState {
    ...
    accumulator_merge_totals: IndexMap<(AccountAddress, TypeTag), u128>,
    accumulator_split_totals: IndexMap<(AccountAddress, TypeTag), u128>,
}
    ...
    pub fn new(
        ...
        Self {
            ...
            state: ObjectRuntimeState {
                ...
                accumulator_merge_totals: IndexMap::new(),
                accumulator_split_totals: IndexMap::new(),
            },
            is_metered,
            protocol_config,
            metrics,
